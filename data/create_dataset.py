...
def createDataset(outputPath, imagePathList, labelList, imageDir, lexiconList=None, checkValid=True):
    """
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--out', type = str, required = True, help = 'lmdb data output dir')
    ...
    args.out = params.lmdb_dir
    args.folder = params.img_dir
    args.file = params.label_path
    
    if args.file is not None:
        image_path_list, label_list = read_data_from_file(args.file)
        createDataset(args.out, image_path_list, label_list, args.folder)
